...
if (isset($_REQUEST['login_button']) === true){
	...
	//tama ang username pero mali and password
	...
	}// end of the correct username and password
				...
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
					 ...
					 echo  "<div class = 'alert alert-danger' role='alert'>Username does not exist...</div>";
							...
							echo  "<div class = 'alert alert-warning' role='alert'>You are still login. Please <a href = 'account.php'>
							click here </a> to proceed.</div>";
